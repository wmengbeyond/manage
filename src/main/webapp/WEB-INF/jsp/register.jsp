        ...
        <div class="col-md-4 col-sm-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!-- 表单 -->
                    <form id="login_form" name="login_form" class="form-horizontal" style="">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button id="submit" type="submit" class="btn btn-danger btn-block btn-flat">
                                    注 册</button>
                            </div>
                        </div>
                    </form>
    ...
    function validatorInit() {
        $('#login_form').bootstrapValidator({
            ...
            .on('success.form.bv', function(e) {
                ...
                // 加密
                var password = infoEncrypt(userID, password1, checkCode)
