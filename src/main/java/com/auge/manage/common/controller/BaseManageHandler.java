...
import com.auge.manage.domain.Supplier;
 ...
 * @author Ken
 */
@RequestMapping(value = "/**/baseManage")
@Controller
public class BaseManageHandler {
     ...
     * @return 返回指定条件查询的结果
     */
    private Map<String, Object> query(Integer searchType, String keyWord) throws BaseManageServiceException {
        Map<String, Object> queryResult = null;

        queryResult = baseManageService.selectWarehouse(searchType, keyWord);
    ...
    @RequestMapping(value = "getWarehouseRecords", method = RequestMethod.GET)
    public
    @ResponseBody
    Map<String, Object> getCustomerList(@RequestParam("searchType") Integer searchType,
                                        @RequestParam("keyWord") String keyWord) throws BaseManageServiceException {
        // 初始化 Response
